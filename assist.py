...
# Key to switch aim location (set to None to Enable)
aim_switch = keycodes.Begin
#aim_switch = True
...
if fov < 0.1 or fov > 3.0:  # you can delete this if you know what you're doing
    ...
    exit(1)
if distance_limit is not None and distance_limit <= 0:88
